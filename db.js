...
export async function initDb() {
  ...
  const defaults = [
      ...
      ['chatbot_temperature', '0.7', 'text'],
      ['chatbot_max_tokens', '600', 'number'],
      ...
      ['nav_link_faq', 'FAQ', 'text'],
      ['nav_whatsapp_label', 'WhatsApp Us', 'text'],
      ['nav_book_label', 'Book a Call', 'text'],
      ['trust_1_bold', '7 to 14 Day', 'text'],
      ['trust_1_text', 'Delivery', 'text'],
      ['trust_2_bold', '100%', 'text'],
      ['trust_2_text', 'Ownership', 'text'],
      ['trust_3_bold', 'Real Sales', 'text'],
      ['trust_3_text', 'Proof', 'text'],
      ['hero_visual_domain', 'nexatech.store', 'text'],
      ['chip_1_title', 'New Sale $450', 'text'],
      ['chip_1_sub', 'Elegance Mode - just now', 'text'],
      ['chip_2_title', 'Order #1029 Shipped', 'text'],
      ['chip_2_sub', 'GlowLab - 2m ago', 'text'],
      ['chip_3_title', '3.2% Conversion Rate', 'text'],
      ['chip_3_sub', 'TechNest - today', 'text'],
      ['stat_stores_label', 'Stores Launched', 'text'],
      ['stat_sales_label', 'Verified Sales', 'text'],
      ['stat_clients_label', 'Happy Clients', 'text'],
      ['stat_launch_label', 'Avg Launch', 'text'],
      ['portfolio_eyebrow', 'Portfolio', 'text'],
      ['filter_all', 'All', 'text'],
      ['filter_fashion', 'Fashion', 'text'],
      ['filter_beauty', 'Beauty', 'text'],
      ['filter_gadgets', 'Tech Gadgets', 'text'],
      ['filter_fitness', 'Fitness', 'text'],
      ...
      ['proof_eyebrow', 'Proof', 'text'],
      ['proof_caption_fallback', 'Verified sales proof', 'text'],
      ['experts_eyebrow', 'Team', 'text'],
      ['team_view_all', 'View full team', 'text'],
      ['how_eyebrow', 'Process', 'text'],
      ['pricing_eyebrow', 'Pricing', 'text'],
      ['pricing_popular_badge', 'Most Popular', 'text'],
      ['pricing_cta_template', 'Choose {name}', 'text'],
      ['mentorship_eyebrow', 'Mentorship', 'text'],
      ['mentorship_cta', 'Chat about Mentorship', 'text'],
      ['testimonials_eyebrow', 'Testimonials', 'text'],
      ['testi_fallback', 'Great experience with Nexatech.', 'text'],
      ['testi_role_fallback', 'Verified buyer', 'text'],
      ['reviews_eyebrow', 'Customer Reviews', 'text'],
      ['reviews_empty', 'No reviews uploaded yet add them in Admin - Media Manager - Review Screenshots.', 'text'],
      ['review_caption_fallback', 'Customer Review', 'text'],
      ['review_video_label', 'Video Review', 'text'],
      ['certs_eyebrow', 'Awards', 'text'],
      ['certs_empty', 'No certificates uploaded yet - add them in Admin - Media Manager - Certificates & Awards.', 'text'],
      ['cert_caption_fallback', 'Certificate', 'text'],
      ['faq_eyebrow', 'FAQ', 'text'],
      ['cta_whatsapp_label', 'Chat on WhatsApp', 'text'],
      ['cta_book_label', 'Book a Free Call', 'text'],
      ['footer_tagline', 'We engineer high-converting storefronts backed by real, current sales proof.', 'text'],
      ['footer_quick_links', 'Quick Links', 'text'],
      ['footer_contact', 'Contact', 'text'],
      ['footer_legal', 'Legal', 'text'],
      ['footer_built_note', 'Built with honesty all proof numbers are live from our database.', 'text'],
      ['privacy_link_label', 'Privacy Policy', 'text'],
      ['terms_link_label', 'Terms of Service', 'text'],
      ...
      ['form_step_1', 'Step 1 of 3 Vision', 'text'],
      ['form_step_2', 'Step 2 of 3 Qualification', 'text'],
      ['form_step_3', 'Step 3 of 3 Contact & Delivery', 'text'],
      ['form_back', 'Back', 'text'],
      ...
      ['form_wa_invalid', 'Enter a valid WhatsApp number', 'text'],
      ['form_consent_required', 'Consent required', 'text'],
      ['form_consent_text', 'I agree to be contacted via WhatsApp/Email about my application. *', 'text'],
      ['form_success_email_note', 'We have sent details to {email} - please check your inbox (and spam folder).', 'text'],
      ['form_label_name', 'Full Name *', 'text'],
      ['form_ph_name', 'Ada Lovelace', 'text'],
      ['form_label_store', 'Desired Brand / Niche Name *', 'text'],
      ['form_ph_store', 'GlowLab', 'text'],
      ['form_label_niche', 'Preferred Niche *', 'text'],
      ['form_label_niche_other', 'Other niche tell us', 'text'],
      ['form_ph_niche_other', 'e.g. Eco-friendly baby products', 'text'],
      ['form_label_investment', 'Investment Range *', 'text'],
      ['form_label_status', 'Current Status *', 'text'],
      ['form_label_scammed', 'Previously lost money to a fake mentor/agency? *', 'text'],
      ['form_label_scam_details', 'What happened? (so we can help better)', 'text'],
      ['form_ph_scam_details', 'Briefly describe...', 'text'],
      ['form_label_whatsapp', 'WhatsApp number *', 'text'],
      ['form_ph_whatsapp', '812 345 6789', 'text'],
      ['form_label_email', 'Business Email *', 'text'],
      ['form_ph_email', 'you@example.com', 'text'],
      ['form_label_contact_time', 'Preferred contact time / timezone', 'text'],
      ['form_ph_contact_time', 'e.g. Evenings WAT', 'text'],
      ['form_label_source', 'How did you hear about us?', 'text'],
      ['form_label_traffic', 'Traffic-source plan', 'text'],
      ['chat_title', 'Nexatech Assistant', 'text'],
      ['chat_new', '+ New Chat', 'text'],
      ['chat_recent', 'Recent', 'text'],
      ['chat_whatsapp_btn', 'WhatsApp Us', 'text'],
      ['chat_no_recent', 'No recent chats yet - start a conversation first.', 'text'],
      ['chat_greeting', 'Hi {name}! I am the Nexatech assistant. Ask me about packages, timelines, or proof or tap a quick question below.', 'text'],
      ['chat_quick_1', 'What is included in Pro?', 'text'],
      ['chat_quick_2', 'How long to launch?', 'text'],
      ['chat_quick_3', 'Do I own the store?', 'text'],
      ['chat_placeholder', 'Type a message...', 'text'],
      ['chat_send', 'Send', 'text'],
      ['chat_gate_intro', 'Hi! Before we start, please tell us your name and email so we can follow up.', 'text'],
      ['chat_gate_name_label', 'YOUR NAME', 'text'],
      ['chat_gate_email_label', 'EMAIL', 'text'],
      ['chat_gate_start', 'Start Chat', 'text'],
      ['chat_gate_err_name', 'Please enter your name.', 'text'],
      ['chat_gate_err_email', 'Please enter a valid email.', 'text'],
      ['chat_chatting_as', 'Chatting as', 'text'],
      ['chat_switch', 'switch', 'text'],
      ['chat_offline', 'Not available right now - tap below to chat on WhatsApp.', 'text'],
